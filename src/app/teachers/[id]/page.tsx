...
import { AchievementCard } from "@/components/cards/AchiveMentCart";
import { MedalIcon } from "lucide-react";

export default function TeacherDetailPage() {
  const params = useParams();
  const { teacher, loading, error, updateTeacher } = useTeacher(
    params.id as string
  );
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="grid gap-6 sm:grid-cols-2 h-full">
            <AchievementCard
              title="Best Math Teacher Award"
              description="Awarded for exceptional teaching in advanced mathematics."
              date="June 2024"
              badgeLabel="Award"
              icon={<MedalIcon />}
            />
